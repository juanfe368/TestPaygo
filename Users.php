            ...
            <div class="row">
                <form enctype="multipart/form-data" class="form-horizontal" method="POST" onsubmit="return respuestForm();" action="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <input type="radio" class="form-control" id="inputRadOrdernAsc" name="inputRadOrdern" value="asc">Ascendente
                            <input type="radio" class="form-control" id="inputRadOrdernDsc" name="inputRadOrdern" value="dsc">Descendente
                        </div>
                    </div>
                      <div class="form-group">
